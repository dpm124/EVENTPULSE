...
namespace EVENTPULSE
{
    public partial class MainWindow : Window
    {
        ...
        private bool ValidarUsuario(string correo, string contraseña, out string nombreUsuario)
        {
            ...
            string rutaArchivo = "C:/Users/alexs/EVENTPULSE/Correos/correos.txt";
        ...
        private void OnAccederClick(object sender, RoutedEventArgs e)
        {
            ...
            if (ValidarUsuario(correoIngresado, contraseñaIngresada, out string nombreUsuario))
            {
                ...
                // Añadir etiqueta de último acceso
                TextBlock lastAccess = new TextBlock
                {
                    Text = "Último acceso hace x días",
                    FontSize = 14,
                    FontFamily = new System.Windows.Media.FontFamily("Segoe UI"),
                ...
                RightPanel.Children.Add(lastAccess);
        ...
        private void ResetLoginView()
        {
            ...
            // Añadir nuevamente la interfaz de login
            Image userIcon = new Image
            {
                Source = new System.Windows.Media.Imaging.BitmapImage(new System.Uri("/icon-7797704.png", System.UriKind.Relative)),
                Width = 136,
                Height = 123,
                Margin = new Thickness(0, 20, 0, 20)
            };
